...
if config_env() != :test do
  config :supavisor,
    ...
    api_jwt_secret: (System.get_env("API_JWT_SECRET") || raise "API_JWT_SECRET is missing"),
    metrics_jwt_secret: (System.get_env("METRICS_JWT_SECRET") || raise "METRICS_JWT_SECRET is missing"),
    ...
    tenants_db_ssl: true  # Enable SSL for tenant DBs

  config :supavisor, Supavisor.Repo,
    url: System.get_env("DATABASE_URL", "ecto://postgres:postgres@localhost:6432/postgres"),
    pool_size: System.get_env("DB_POOL_SIZE", "3") |> String.to_integer(),
    ssl: [cacertfile: "/etc/ssl/certs/rds-ca.pem", verify: :verify_peer],
    parameters: [
...
config :supavisor, :tenants_db_ssl, require: true